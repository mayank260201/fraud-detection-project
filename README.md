...
This project demonstrates a complete industry-style data science workflow, including handling highly imbalanced data, creating meaningful features, training ML models, and evaluating performance using ROC-AUC, precision, recall, and feature importance.
